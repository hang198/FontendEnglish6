...
var bootstrap = function (t, e, n) {
  ...
  var s = function () {
    ...
    var t = "modal", n = ".bs.model", i = e.fn[t], o = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
      a = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, l = {
        ...
        return u.toggle = function (t) {
          ...
          e.removeData(this._element, "bs.model"), e(window, document, this._element, this._backdrop).off(n), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
          ...
          return this.each(function () {
            var s = e(this).data("bs.model"), r = e.extend({}, i.Default, e(this).data(), "object" == typeof t && t);
            if (s || (s = new i(this, r), e(this).data("bs.model", s)), "string" == typeof t) {
    ...
    return e(document).on(l.CLICK_DATA_API, c.DATA_TOGGLE, function (t) {
      ...
      r && (n = e(r)[0]);
      var o = e(n).data("bs.model") ? "toggle" : e.extend({}, e(n).data(), e(this).data());
    ...
    var t = "tooltip", i = ".bs.tooltip", o = e.fn[t], a = new RegExp("(^|\\s)bs-tooltip\\S+", "g"), l = {
      ...
      g = {HOVER: "hover", FOCUS: "focus", CLICK: "click", MANUAL: "manual"}, m = function () {
        ...
        return m.enable = function () {
          ...
          clearTimeout(this._timeout), e.removeData(this.element, this.constructor.DATA_KEY), e(this.element).off(this.constructor.EVENT_KEY), e(this.element).closest(".model").off("hide.bs.model"), this.tip && e(this.tip).remove(), this._isEnabled = null, this._timeout = null, this._hoverState = null, this._activeTrigger = null, null !== this._popper && this._popper.destroy(), this._popper = null, this.element = null, this.config = null, this.tip = null
        }, m.show = function () {
          var t = this;
          ...
          this.config.trigger.split(" ").forEach(function (n) {
            ...
            e(t.element).closest(".model").on("hide.bs.model", function () {
              return t.hide()
            })
